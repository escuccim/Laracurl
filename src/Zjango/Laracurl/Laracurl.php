...
class Laracurl {
	 ...
	 * @return void
	 */
	public function prepareRequest(Request $request, array $headers)
	{
		$this->ch = curl_init();
		...
		foreach($headers as $header => $content){
			if($header == 'useragent'){
				curl_setopt($this->ch, CURLOPT_USERAGENT, $content);
			}
		}
	 ...
	 * @return Response
	 */
	public function sendRequest(Request $request, array $headers)
	{
